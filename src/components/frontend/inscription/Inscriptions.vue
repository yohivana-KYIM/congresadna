<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#9C7C13] to-[#D4AF37] p-6"
  >
    <div class="w-full max-w-2xl p-8 bg-white shadow-2xl rounded-2xl">
      <h2 class="text-4xl font-bold text-center mb-8 text-[#9C7C13]">
      ...
      <div class="relative pt-1 mb-8">
        <div class="flex items-center justify-between mb-2">
          <div>
            <span
              class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-[#9C7C13] bg-[#D4AF37] bg-opacity-20"
            >
              Progression
            </span>
          </div>
        ...
        <div
          class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-[#D4AF37] bg-opacity-20"
        >
          <div
      ...
      >
        <h3 class="text-2xl font-semibold mb-6 text-[#9C7C13]">
        ...
        <form @submit.prevent="nextStep" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            >
            <input
              v-model="sponsorData.password_confirmation"
              type="password"
      ...
      >
        ...
        <form @submit.prevent="nextStep" class="space-y-6">
          <div class="space-y-2">
            ...
            >
            <input
              v-model="sponsorData.nomEntreprise"
              type="text"
          ...
          <div class="space-y-2">
            ...
            >
            <input
              v-model="sponsorData.nomDirigeant"
              type="text"
          ...
          <div class="space-y-2">
            <label class="block font-medium text-gray-700"
              >Email du dirigeant</label
            >
            <input
              v-model="sponsorData.emailDirigeant"
              type="email"
      ...
      >
        ...
        <form @submit.prevent="registerSponsor" class="space-y-6">
          <div class="space-y-2">
            <label class="block font-medium text-gray-700"
              >Comment contacter</label
            >
            <textarea
              v-model="sponsorData.commentContacter"
              placeholder="Comment contacter"
              class="h-24 resize-none input-field"
            ></textarea>
          </div>
          <div class="space-y-2">
            <label class="block font-medium text-gray-700">Site web</label>
            <input
              v-model="sponsorData.siteWeb"
              type="url"
      ...
      <div
        v-if="errorMessage"
        class="p-4 mt-6 text-red-700 bg-red-100 border-l-4 border-red-500"
      >
